...
export const aUserEdge = (overrides?: Partial<UserEdge>, relationshipsToOmit: Set<string> = new Set()): UserEdge => {
...
export const aUsers = (overrides?: Partial<Users>, relationshipsToOmit: Set<string> = new Set()): Users => {
    relationshipsToOmit.add('Users');
    return {
        totalCount: overrides && overrides.hasOwnProperty('totalCount') ? overrides.totalCount! : 8684,
